/*! extended-css - v1.0.9 - 2018-02-20
...
var ExtendedCss = function (styleSheet) {
    ...
    */
    ...
    /**
     * This flag indicates that we should enable performance debugging for all selectors.
     */
    ...
    var applyRule = function (rule) {
        var debug = globalDebugFlag || rule.debug;
        var start;
        if (debug) {
        ...
        if (debug) {
            ...
            console.log('[ExtendedCss] Applying a rule ' + rule.selector.selectorText + ' took ' + elapsed + 'ms.');
        }
    ...
    /**
     * Sets the global debugging flag to the provided value. Defaults to false.
     * @param {boolean} flag
     */
    this.setGlobalDebugFlag = function (flag) {
