...
/* global Sizzle, ExtendedSelector, utils */
    ...
    Parser.prototype = {
        ...
        parseCss: function () {
            ...
            while (this.cssText) {
                ...
                var selectors = parseResult.selectors;
                ...
                if (typeof debugPropertyValue !== 'undefined') {
                    if (debugPropertyValue === 'global') {
                        ExtendedSelector.prototype.debug = true;
                    }
                    debug = true;
                ...
                var iSelectors = selectors.length;
                while (iSelectors--) {
                    var selector = selectors[iSelectors];

                    try {
                        var extendedSelector = new ExtendedSelector(selector.selectorText, selector.groups, debug);
                        ...
                        utils.logError("ExtendedCssParser: ignoring invalid selector " + selector.selectorText);
                    }
                }
            }
