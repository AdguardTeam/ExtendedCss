...
     */
    ...
    var handleDomChangeAsync = function () {
        ...
        if (window.requestAnimationFrame && DomObserver.mutationObserverSupport) {
    ...
    var observe = function () {
        ...
        domObserved = true;
        DomObserver.observeDom(handleDomChangeAsync);
    };
    ...
    var dispose = function () {
        if (domObserved) {
            DomObserver.disconnectDom(handleDomChangeAsync);
            domObserved = false;
        }
