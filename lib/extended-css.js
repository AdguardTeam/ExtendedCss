...
/* global ExtendedCssParser, ExtendedSelectorFactory, StyleObserver, console, utils */
...
var ExtendedCss = function (styleSheet, propertyFilterIgnoreStyleNodes) { // jshint ignore:line
    ...
    var applyRule = function (rule) {
        ...
        if (debug) {
            ...
            console.log('[ExtendedCss] Elapsed ' + elapsed.toFixed(2) + ' for applying a rule ' + rule.selector.selectorText);
        }
    ...
    this.findAffectedElement = findAffectedElement;
