...
utils.Stats = function (timingArray) {
    ...
    let sum = 0;
    let squaredSum = 0;
    let len = timingArray.length;
    for (let i = 0; i < len; i++) {
        let num = timingArray[i];
        sum += num;
        squaredSum += num * num;
    }
...
utils.logError = (typeof console !== 'undefined' && console.error && Function.prototype.bind) ?
    console.error.bind(window.console) : function () { };

/** Safe console.info version */
utils.logInfo = (typeof console !== 'undefined' && console.info && Function.prototype.bind) ?
    console.info.bind(window.console) : function () { };
