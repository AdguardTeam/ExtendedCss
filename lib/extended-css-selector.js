...
const ExtendedSelectorFactory = (function() { // jshint ignore:line
    ...
    const PSEUDO_EXTENSIONS_MARKERS = [ ":has", ":contains", ":has-text", ":matches-css", ":properties", ":-abp-has", ":-abp-has-text", ":-abp-properties", ":if", ":if-not" ];
    ...
    ExtendedSelectorFactory.prototype = {
        ...
        createSelector: function() {
            ...
            return new SplittedSelector(selectorText, simple, relation, complex, debug);
        },
        /**
         * @private
    ...
    return {
        ...
        createSelector: function(selector, tokens, debug) {
            return new ExtendedSelectorFactory(selector, tokens, debug).createSelector();
        },
        /**
