...
var StylePropertyMatcher = (function (window, document) { // jshint ignore:line
    ...
    var extendSizzle = function (sizzle) {
        ...
        sizzle.selectors.pseudos["style-properties"] = sizzle.selectors.createPseudo(function (propertyFilter) {
            var matcher = new Matcher(propertyFilter);
            return function (element) {
                return matcher.matches(element);
            };
        });
        sizzle.selectors.pseudos["style-properties-before"] = sizzle.selectors.createPseudo(function (propertyFilter) {
            var matcher = new Matcher(propertyFilter, ":before");
            return function (element) {
                return matcher.matches(element);
            };
        });
        sizzle.selectors.pseudos["style-properties-after"] = sizzle.selectors.createPseudo(function (propertyFilter) {
